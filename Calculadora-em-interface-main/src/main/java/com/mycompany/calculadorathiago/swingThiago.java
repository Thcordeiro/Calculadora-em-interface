 ...
 * @author ALUNO
 */
public class swingThiago extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Calculadora do Thiago");
    ...
    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {
        thiagoCalc.setText(thiagoCalc.getText()+ "0");
    }
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {
        thiagoCalc.setText(thiagoCalc.getText()+ "1");
    }
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {
    
        thiagoCalc.setText(thiagoCalc.getText()+ "2");
    }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        thiagoCalc.setText(thiagoCalc.getText()+ "4");
    }

    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {
       
        thiagoCalc.setText(thiagoCalc.getText()+ "5");
    }

    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {
        
        thiagoCalc.setText(thiagoCalc.getText()+ "6");
    }

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {/
        
        thiagoCalc.setText(thiagCalc.getText()+ "7");
    }

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {
        
        thiagoCalc.setText(thiagoCalc.getText()+ "8");
    }

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {
        
        thiagoCalc.setText(thiagoCalc.getText()+ "9");
    }

    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {
       
        thiagoV1 = Double.parseDouble(thiagoCalc.getText());
        thiagoCalc.setText("");
        thiagoSinal = "somar";
    }
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        thiagoV2 = Double.parseDouble(thiagoCalc.getText());
        if (thiagoSinal == "somar"){
            thiagoCalc.setText(String.valueOf(thiagoV1+thiagoV2));
        }
        if (thiagoSinal == "subtração"){
             thiagoCalc.setText(String.valueOf(thiagoV1-thiagoV2));
            
        }
        
        if(thiagoSinal == "multiplicação"){
             thiagoCalc.setText(String.valueOf(thiagoV1*thiagoV2));
        }
        
        if(thiagoSinal == "divisão"){
             thiagoCalc.setText(String.valueOf(thiagoV1/thiagoV2));
        }
    }
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        thiagoV1 = Double.parseDouble(thiagoCalc.getText());
        thiagoCalc.setText("");
        thiagoSinal = "subtração";
    }
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {
       
        thiagoV1 = Double.parseDouble(thiagoCalc.getText());
        thiagoCalc.setText("");
        thiagoSinal = "multiplicação";
    }
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        thiagoCalc.setText(thiagoCalc.getText()+ ".");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(swingThiago.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new swingThiago().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField thiagoCalc;
